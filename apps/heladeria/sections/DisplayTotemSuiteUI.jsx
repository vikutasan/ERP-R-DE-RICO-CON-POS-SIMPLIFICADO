...
/**
 * DisplayTotemSuiteUI — Landing de la sub-suite "Display Tótem".
 *
 ...
 */
export const DisplayTotemSuiteUI = ({ onBack, onSelectTool }) => {
    const [hoveredIdx, setHoveredIdx] = useState(null);

    const tools = [
        {
            id: 'config',
            nombre: 'Configurador de Tótem',
            descripcion: 'Sube macros y heroes, ajusta duración, transición y formato. Vista previa en vivo del ciclo completo.',
            icono: '🎨',
        },
        {
            id: 'selector',
            nombre: 'Display de Tótem',
            descripcion: 'Proyecta el tótem en uno o varios monitores a la vez. Cada pantalla abre en su propia ventana.',
            icono: '🖥️',
        },
    ];
        ...
        <div style={{
            ...
            <div style={{
                ...
                <h1 style={{
                    ...
                    Gestor de Display Tótem
                </h1>
                <p style={{
                    margin: '16px 0 0',
                    fontSize: '28px', color: '#6b7280', fontWeight: '500',
                }}>
                    Sub-suite de contenido sugestivo y proyección
                </p>
            </div>
